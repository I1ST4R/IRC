...
import { Liked, useGetLikedQuery} from "@/modules/LikedBody";
...
export const Product = ({ product, userId }: ProductProps) => {
  const { data: likedItems = {} } = useGetLikedQuery(userId ?? "", { skip: !userId })
